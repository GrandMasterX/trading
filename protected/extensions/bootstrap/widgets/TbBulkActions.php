...
class TbBulkActions extends CComponent
{
    ...
    /**
     * @var bulAction buttons html class 
     */
    public $htmlClass;    
    
    /**
     * @var bulAction buttons position 
     */
    public $position;        
    
    /**
     * @var bulAction buttons position offset 
     */
    public $bulkActionPositionOffset;
	...
	public function renderButtons()
	{
		...
		echo CHtml::openTag('div', array('id' => $this->htmlClass, 'style' => 'position:relative', 'class' => $this->align . ', ' . $this->htmlClass));
	...
	public function registerClientScript()
	{
        ...
        $cs->registerCssFile($assetsUrl . '/css/bootstrap-bulk.css');
...
EOD;
        ...
        if ($this->position=='top')
        {
            ...
            $js .= "$('#{$this->htmlClass}').sticky({topSpacing:{$this->bulkActionPositionOffset}});";
        }        
