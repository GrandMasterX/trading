...
class Chosen extends CInputWidget
{
    ...
    /*Allows us to make search with part of the word in list*/
    ...
    public function init()
    {
        ...
        if(!$this->multiple)
            $this->settings['enable_split_word_search'] = $this->enableSplitWordSearch;
        /*if(!$this->multiple)
            $this->settings['disable_search_threshold'] = $this->searchThreshold;*/
    }
