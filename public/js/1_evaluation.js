...
(function($){
    ...
    $.rangeFormula = {
        evaluate: function() {
            ...
            //console.log(print_r(window.evaluation['evaluation']));
            if(window.evaluation['status']['result']==1) {
                for(var index in window.evaluation['evaluation']) {
                    console.log('---------- '+index+' -------------');
                    console.log('тут есть размеры recomended: '+ print_r(window.evaluation['evaluation'][index]['recomended']));
                    console.log('Диапазон: '+ print_r(window.evaluation['evaluation'][index]['rangeProperties']));
                }
            } else {
                console.log('No size fitting you!');
            }
